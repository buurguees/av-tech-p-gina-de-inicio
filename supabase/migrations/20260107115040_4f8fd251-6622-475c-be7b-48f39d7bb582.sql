-- Drop the overloaded function that has p_created_at parameter
...
-- Drop the original function too
DROP FUNCTION IF EXISTS public.update_client(
  p_client_id uuid,
  p_company_name text,
  p_contact_phone text,
...
-- Recreate a single unified function with all parameters including created_at
