    ...
    <div className="min-h-screen bg-black pb-mobile-nav">
      ...
      <main className="max-w-[1600px] mx-auto px-3 sm:px-6 lg:px-8 py-3 md:py-6">
        <Tabs defaultValue="products" className="space-y-4 md:space-y-6">
          <TabsList className="bg-white/5 border border-white/10 h-9 md:h-10 w-full grid grid-cols-3">
            <TabsTrigger 
              value="products" 
              className="data-[state=active]:bg-orange-500 data-[state=active]:text-white text-white/60 text-xs md:text-sm h-7 md:h-8"
            >
