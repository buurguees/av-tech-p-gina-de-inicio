...
const CreateProjectDialog = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Call RPC with explicit type assertion to avoid PGRST203 overload ambiguity
      // We use the signature WITHOUT p_project_name (it's auto-generated by DB)
      const { error } = await (supabase.rpc as Function)("create_project", {
