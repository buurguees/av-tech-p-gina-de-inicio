...
import PurchaseInvoicePaymentsSection from "./components/PurchaseInvoicePaymentsSection";
                            ...
                            <CardContent className="p-0 h-full">
                                ...
                                <div className="h-[300px] bg-black/20 flex flex-col items-center justify-center p-3">
                                    {pdfUrl ? (
                                        ...
                                        <div className="w-full h-full flex items-center justify-center">
                                            <div className="bg-white/5 border border-white/10 p-8 rounded-xl flex flex-col items-center gap-3">
                                                <Loader2 className="h-8 w-8 text-white/20 animate-spin" />
                                                <p className="text-white/40 text-xs font-medium">Cargando...</p>
                                            </div>
                                        </div>
                                    ) : (
                                        <>
