    ...
    return (
      <div className="space-y-3 mb-6">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-bold">Pendientes de Revisar</h2>
        ...
        <div className="space-y-2">
          {pendingInvoices.map((inv) => (
            <Card
              key={inv.id}
              className="cursor-pointer active:scale-[0.98] transition-transform border-blue-500/20 bg-blue-500/5"
