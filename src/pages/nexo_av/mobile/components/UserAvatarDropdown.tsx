    ...
    <>
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button className="flex items-center justify-center w-9 h-9 rounded-full bg-secondary hover:bg-secondary/80 transition-colors text-foreground font-semibold text-xs focus:outline-none focus:ring-2 focus:ring-ring">
            {initials}
          </button>
        </DropdownMenuTrigger>
        <DropdownMenuContent 
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="text-base">Editar información</DialogTitle>
          ...
          <form onSubmit={handleEditSubmit}>
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                ...
                />
                <p className="text-[10px] text-muted-foreground">El email no se puede cambiar.</p>
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="position" className="text-xs">Cargo</Label>
                <Input
                  id="position"
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <form onSubmit={handlePasswordSubmit}>
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="confirmPassword" className="text-xs">Confirmar nueva contraseña</Label>
                <div className="relative">
                  <Input
                    id="confirmPassword"
