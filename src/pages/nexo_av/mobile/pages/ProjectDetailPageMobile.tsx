...
import DetailTabsMobile from "../components/DetailTabsMobile";
import ProjectDashboardTab from "../components/ProjectDashboardTab";
import ProjectDashboardTabMobile from "../components/ProjectDashboardTabMobile";
  ...
  return (
    <div className="min-h-screen bg-background pb-mobile-nav">
      <main className="px-3 py-3 space-y-3">
        ...
        {/* Header Card - Información clave (solo lo esencial) */}
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
              ...
              {project.client_name && (
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-white text-sm font-medium truncate">{project.client_name}</p>
                  </div>
                </div>
              )}

              {/* Ubicación - Solo local o ciudad (lo más importante) */}
        ...
        >
          ...
          >
            <TabsContent value="dashboard" className="mt-3">
              <ProjectDashboardTabMobile project={project} />
            </TabsContent>
