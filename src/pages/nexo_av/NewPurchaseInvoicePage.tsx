...
const NewPurchaseInvoicePageMobile = lazy(() => import("./mobile/NewPurchaseInvoicePageMobile"));
...
export default createMobilePage({
  DesktopComponent: NewPurchaseInvoicePageDesktop,
  MobileComponent: NewPurchaseInvoicePageMobile,
});
