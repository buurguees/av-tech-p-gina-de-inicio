import { Package, Briefcase, Wrench, Coffee, Truck, Coins, MapPin } from "lucide-react";
...
export const SUPPLIER_CATEGORIES = [
  ...
  { value: 'DIETAS', label: 'Dietas', icon: Coffee, color: 'text-orange-600', bgColor: 'bg-orange-100' },
  { value: 'GASOLINA', label: 'Gasolina', icon: Truck, color: 'text-red-600', bgColor: 'bg-red-100' },
  { value: 'PEAJES', label: 'Peajes', icon: Coins, color: 'text-amber-600', bgColor: 'bg-amber-100' },
  { value: 'PARKINGS', label: 'Parkings', icon: MapPin, color: 'text-cyan-600', bgColor: 'bg-cyan-100' },
] as const;
