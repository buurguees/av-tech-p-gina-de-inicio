import { Package, Briefcase, Wrench, Utensils, Fuel, CircleDollarSign, ParkingCircle } from "lucide-react";
...
export const SUPPLIER_CATEGORIES = [
  ...
  { value: 'GASOLINA', label: 'Gasolina', icon: Fuel, color: 'text-red-600', bgColor: 'bg-red-100' },
  { value: 'PEAJES', label: 'Peajes', icon: CircleDollarSign, color: 'text-amber-600', bgColor: 'bg-amber-100' },
  { value: 'PARKINGS', label: 'Parkings', icon: ParkingCircle, color: 'text-cyan-600', bgColor: 'bg-cyan-100' },
] as const;
