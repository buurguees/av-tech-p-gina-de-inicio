...
| | |
|---|---|
| **Cuándo cargar** | Inicializar agente con contexto completo; tareas de refactor, nuevas funcionalidades o revisiones técnicas. |
| **Cuándo NO cargar** | Peticiones puntuales sin impacto funcional; comandos aislados de una línea. |
| **Integración .codex** | Tras cambios relevantes, registrar en `.codex/avances.md` si se desbloquea capacidad; en `.codex/errores-soluciones.md` si se corrige un error. |
...
- Registrar avances en `.codex/avances.md` y errores corregidos en `.codex/errores-soluciones.md`.
